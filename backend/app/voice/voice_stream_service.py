...
async def _collect_final_transcript(audio_stream: AsyncIterator[bytes], api_key: str) -> str:
    ...
    *,
    ...
    try:
        transcript = await asyncio.wait_for(
            _collect_final_transcript(_audio_from_telnyx(websocket), settings.deepgram_api_key),
