...
| Voice call control | `integrations/contracts.py` → `VoiceCallControl` | `VOICE_PROVIDER` | Telnyx / Twilio / Vonage (all primary-ready) |
| Voice webhooks | `integrations/contracts.py` → `VoiceWebhookAdapter` | `VOICE_PROVIDER` + header detect | Telnyx / Twilio / Vonage |
