...
| Voice call control | `integrations/contracts.py` → `VoiceCallControl` | `VOICE_PROVIDER` | Telnyx TeXML (Twilio TwiML primary-ready) |
| Voice webhooks | `integrations/contracts.py` → `VoiceWebhookAdapter` | follows `VOICE_PROVIDER` | Telnyx (Twilio HMAC) |
